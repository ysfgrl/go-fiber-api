...
type ElasticRepository[CType ElasticCollections] struct {
	client *elasticsearch.TypedClient
	ctx    context.Context
	index  string
}

func (repo *ElasticRepository[CType]) Get(id string) (*CType, *models.Error) {
...
func (repo *ElasticRepository[CType]) GetByFirst(key string, value any) (*CType, *models.Error) {
	//TODO implement me
	panic("implement me")
}

func (repo *ElasticRepository[CType]) List(schema models.ListRequest) (*models.ListResponse[CType], *models.Error) {
	schema.Page -= 1
...
func (repo *ElasticRepository[CType]) Add(schema CType) (*CType, *models.Error) {
	//TODO implement me
	panic("implement me")
}

func (repo *ElasticRepository[CType]) Delete(id string) (bool, *models.Error) {
	//TODO implement me
	panic("implement me")
}

func (repo *ElasticRepository[CType]) Update(id string, schema CType) (*CType, *models.Error) {
	//TODO implement me
	panic("implement me")
}

func (repo *ElasticRepository[CType]) UpdateField(id string, field string, value any) (*CType, *models.Error) {
	//TODO implement me
	panic("implement me")
}
